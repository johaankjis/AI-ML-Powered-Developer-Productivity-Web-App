    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Paste the code you want to document</CardDescription>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          {generatedDocs ? (
            <div className="bg-muted p-4 rounded-lg overflow-auto min-h-[400px] text-sm prose prose-invert max-w-none">
